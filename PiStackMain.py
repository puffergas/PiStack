...
layout = [
    ...
    [sg.Input((fg_com1), size=(7,1), key='-use_com1-', readonly=True, border_width=(4), text_color='red',
        background_color='white'), sg.Button('<==>', key='-SWITCH_COM1-'), sg.Input(size=(7, 1),
        text_color='red', border_width=(4), key='-stby_com1-'),
            ...
            background_color='white'), sg.Button('<==>', key='-SWITCH_NAV1-'), sg.Input(size=(7, 1),
    ...
    [sg.Input((fg_com2), size=(7,1), key='-use_com2-', readonly=True, border_width=(4), text_color='red',
        background_color='white'), sg.Button('<==>', key='-SWITCH_COM2-'), sg.Input(size=(7, 1),
        text_color='red', border_width=(4), key='-stby_com2-'),
            sg.Input((fg_nav1), size=(7,1), key='-use_nav2-', readonly=True, border_width=(4), text_color='red',
            background_color='white'), sg.Button('<==>', key='-SWITCH_NAV2-'), sg.Input(size=(7, 1),
...
while True: 
    ...
    if boot == True:
        window['-use_com1-'].update(value=555)
        boot = False,
        print(boot)
